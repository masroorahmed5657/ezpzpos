...
@Component({
  selector: 'app-pos-electric',
  templateUrl: './pos-electric.component.html',
  styleUrls: ['./pos-electric.component.scss']
})
export class PosElectricComponent {
private myUrl = environment.apiUrl;
  ...
  faDollar = faDollar;
  currencySign = environment.currency;
  selectedAgent: any;
...
//      if (this.showTaxFlag) {
  ...
  //    }
      ...
      <div class="inv_details">
        <p style="text-align:left"><b> Invoice No.:` + this.invoiceNumber + `</b><br>  
        Date & Time:   &nbsp;` + this.todaydatashow + `<br>
        Customer: Walk-in  <br>
        Payment Method:` + this.payment.paymentMethod + `  </p>
      ...
      tableFooterHtmlTag = tableFooterHtmlTag + taxItemTRTag +
        `<tr> 
         ...
         <tr>
           ...
           <td colspan="3" style="text-align: left;border-bottom: 1px solid #000;"><b>` + this.currencySign + (this.customerBalance).toFixed(2) + `</b> </td>
         </tr>
         <tr>
