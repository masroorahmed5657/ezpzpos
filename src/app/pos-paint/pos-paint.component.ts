...
@Component({
  selector: 'app-pos-paint',
  templateUrl: './pos-paint.component.html',
  styleUrls: ['./pos-paint.component.scss']
})
export class PosPaintComponent {
              ...
              Swal.fire('Submit', 'Sale#' + orderNum + ' completed.', 'success')
                .then((result) => {
                  if (result.isConfirmed) {
                    ...
                    this.printService.printThermal(customer, this.payment, this.cartDataList, this.customerBalance, this.invoiceNumber, this.billCopyNumber);
