...
@media print {
  ...
  billOfSaleSearch(event: any) {
    ...
    if (event.key === 'Enter') {
      // let qtyInput = <HTMLInputElement>document.getElementById('order-search');
      // if (qtyInput === undefined) {
      //   return;
      // }
      ...
      if (billOfSale !== undefined || billOfSale !== '') {
        ...
        this.paymentService.getPartialPaymentByBOS(billOfSale).subscribe((data) => {
          ...
          // else if (payment !== null || payment !== undefined) {
          //   this.paymentList.push(payment);
  ...
  custPhoneSearch(event: any) {
    if (event.key === 'Enter') {
      // let qtyInput = <HTMLInputElement>document.getElementById('phone-search');
      // if (qtyInput === undefined) {
      //   return;
      // }
