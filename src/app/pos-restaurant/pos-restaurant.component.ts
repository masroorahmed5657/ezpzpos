...
@Component({
  ...
  templateUrl: './pos-restaurant.component.html',
  styleUrls: ['./pos-restaurant.component.scss']
})
export class PosRestaurantComponent implements OnInit, OnDestroy {
...
@media print {
  ...
  calculateDiscountTotal(discount: number): any {
    ...
    this.pickupCartDataList.discountPercentage = discount;
