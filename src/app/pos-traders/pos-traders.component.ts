...
@Component({
  selector: 'app-pos-traders',
  templateUrl: './pos-traders.component.html',
  styleUrls: ['./pos-traders.component.scss']
})
export class PosTradersComponent {
  ...
  showWholeSaleFlag = environment.showWholeSaleFlag;
  wholeSaleFlag=false;
  ...
  ngOnInit(): void {
    ...
    this.orderSearch = '';
    this.phoneSearch = '';
    this.showPartialPaymentFlag = environment.showPartialPaymentFlag;

    if (!environment.posCustomerNameFlag) {
      this.customer.firstName = 'POSCustomer';//set default
      this.customer.lastName='Walkin';
    }
