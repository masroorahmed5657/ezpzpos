...
export class ReportsService {
   ...
   /* ************************************************************* */
   getDailySaleTotalCount(): Observable<any> {
      let myUrl = `${this.myUrl}` + `reports/dailySaleTotalCount`;
      return this.http.get<any>(myUrl).pipe(
         catchError(this.errors.handleError<any>('dailySaleTotalCount'))
      );
   }
   ...
   getDailySaleExcel(orderType:any): Observable<OrderSaleReportResponse> {
      let myUrl = `${this.myUrl}` + `reports/dailySale/` + orderType;
   ...
   //    let myUrl = `${this.myUrl}` + `reports/dailySale/`;
   //    return this.http.get<OrderSaleReportResponse>(myUrl).pipe(
